...
var app = (function () {
    ...
    // (36:4) <Link to="/" class="nav-link {path === '/' ? 'active' : ''}" on:click={() => path = '/'}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:4) <Link to=\\\"/\\\" class=\\\"nav-link {path === '/' ? 'active' : ''}\\\" on:click={() => path = '/'}>",
    		ctx
    	});
    ...
    // (37:4) <Link to="/blog" class="nav-link {path.startsWith('/blog') ? 'active' : ''}" on:click={() => path = '/blog'}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(37:4) <Link to=\\\"/blog\\\" class=\\\"nav-link {path.startsWith('/blog') ? 'active' : ''}\\\" on:click={() => path = '/blog'}>",
    		ctx
    	});
    ...
    // (38:4) <Link to="/about" class="nav-link {path === '/about' ? 'active' : ''}" on:click={() => path = '/about'}>
    function create_default_slot$4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(38:4) <Link to=\\\"/about\\\" class=\\\"nav-link {path === '/about' ? 'active' : ''}\\\" on:click={() => path = '/about'}>",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 30, 2, 672);
    			attr_dev(button, "class", "theme-toggle svelte-723d5h");
    			attr_dev(button, "aria-label", "Toggle theme");
    			add_location(button, file$7, 38, 4, 1127);
    			attr_dev(div1, "class", "nav-links svelte-723d5h");
    			add_location(div1, file$7, 34, 2, 748);
    			attr_dev(nav, "class", "nav svelte-723d5h");
    			add_location(nav, file$7, 29, 0, 652);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		// Set initial path
    		$$invalidate(2, path = window.location.pathname);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a1, file$6, 9, 6, 315);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			input = element("input");
    			attr_dev(div0, "class", div0_class_value = "icon-container " + (/*playing*/ ctx[0] ? 'spin' : '') + " svelte-7wte6q");
    			add_location(div0, file$1, 92, 4, 2212);
    			attr_dev(button0, "class", "music-toggle svelte-7wte6q");
    			...
    			attr_dev(button1, "class", "volume-toggle svelte-7wte6q");
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*playing*/ 1 && div0_class_value !== (div0_class_value = "icon-container " + (/*playing*/ ctx[0] ? 'spin' : '') + " svelte-7wte6q")) {
    ...
    function create_default_slot(ctx) {
    	...
    	nav = new Nav({
    			props: {
    				...
    				toggleDarkMode: /*toggleDarkMode*/ ctx[2]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 49, 4, 1375);
    			attr_dev(div, "class", "app-container svelte-uutuxy");
    			add_location(div, file, 46, 2, 1298);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			const nav_changes = {};
    			if (dirty & /*darkMode*/ 2) nav_changes.darkMode = /*darkMode*/ ctx[1];
    			nav.$set(nav_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		if (storedDarkMode !== null) {
    			$$invalidate(1, darkMode = storedDarkMode === 'true');
    		}
    	...
    	return [url, darkMode, toggleDarkMode];
    }
